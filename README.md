...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-164k3ee.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-164k3ee.containers.anotherwebservice.com/
...
```
git clone git@github.com:Skype-Skype/container-164k3ee.git
cd container-164k3ee
```
...
```
docker attach container-164k3ee
```
